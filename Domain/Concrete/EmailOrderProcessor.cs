...
namespace Domain.Concrete
{
    public class EmailSettings 
    {
        ...
        public string MailFromAddress = "rodynastore@example.com";
        ...
        public string FileLocation = @"c:\rodyna_store_emails";
    }
        ...
        public void ProcessOrder(Entities.Cart cart, Entities.ShippingDetails shippingDetails)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                foreach (var line in cart.Lines)
                {
                    ...
                    body.AppendFormat("{0} x {1} (всього: {2:c}", line.Quantity, line.Sweet.Name, subtotal);
                }
